...
const Navbar = () => {
  ...
  return (
    <div className='text-BW bg-gray-300 bg-opacity-20 dark:bg-black dark:bg-opacity-80 backdrop-filter backdrop-blur-lg px-4 py-8 md:px-[48px] md:py-[35px] text-lg w-screen z-10 sticky top-0 '>
      ...
      {/* menu open */}
      <ul className={!nav ? 'hidden' : 'absolute backdrop-filter backdrop-blur-lg text-right right-0 w-full px-8 py-8 my-2'}>
